...
define( 'YOURLS_DB_PASS', 'Klant6kalle,' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'admin_wp_x7as7' );
...
define( 'YOURLS_SITE', 'https://fyndklippet.se' );
...
define( 'YOURLS_COOKIEKEY', 'secretrandomstring' );
